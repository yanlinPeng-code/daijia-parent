...
public class OcrController {
    ...
    public  Result<DriverLicenseOcrVo> driverLicenseOcrVo(@RequestPart("file") MultipartFile file){
        DriverLicenseOcrVo driverLicenseOcrVo=ocrService.driverLicenseOcrVo(file);
